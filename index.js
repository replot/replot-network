(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["NetworkChart"] = factory(require("react"));
	else
		root["NetworkChart"] = factory(root["React"]);
...
var Path = function Path(props) {
  return _react2.default.createElement(
    _reactMotion.Motion,
    {
      ...
      style: {
        x1: (0, _reactMotion.spring)(props.x1, { stiffness: 120, damping: 50 }),
        y1: (0, _reactMotion.spring)(props.y1, { stiffness: 120, damping: 50 }),
        x2: (0, _reactMotion.spring)(props.x2, { stiffness: 120, damping: 50 }),
        y2: (0, _reactMotion.spring)(props.y2, { stiffness: 120, damping: 50 })
      }
    },
...
var NetworkChart = function (_React$Component) {
  ...
  _createClass(NetworkChart, [{
    ...
    value: function getRandomPoints() {
      ...
      try {
        for (var _iterator = this.props.nodes[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var node = _step.value;

          var xPos = Math.floor(Math.random() * this.props.width);
          var yPos = Math.floor(Math.random() * this.props.height);
    ...
    value: function render() {
      ...
      if (this.props.groupKey) {
        ...
        try {
          for (var _iterator2 = this.props.nodes[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
...
var NetworkChartResponsive = function (_React$Component2) {
  _inherits(NetworkChartResponsive, _React$Component2);

  function NetworkChartResponsive() {
    _classCallCheck(this, NetworkChartResponsive);

    return _possibleConstructorReturn(this, (NetworkChartResponsive.__proto__ || Object.getPrototypeOf(NetworkChartResponsive)).apply(this, arguments));
  }

  _createClass(NetworkChartResponsive, [{
    key: "render",
    value: function render() {
      return _react2.default.createElement(
        _replotCore.Resize,
        { width: this.props.width },
        _react2.default.createElement(NetworkChart, this.props)
      );
    }
  }]);

  return NetworkChartResponsive;
}(_react2.default.Component);
...
var _NetworkChart = __webpack_require__(15);

var _NetworkChart2 = _interopRequireDefault(_NetworkChart);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = _NetworkChart2.default;
...
/* harmony default export */ __webpack_exports__["default"] = (GetPointPositions);
